...
public class LoginActivity extends AppCompatActivity {
    ...
    private void createSplashScreenActivity() {
        Intent intent = new Intent(this, com.finalproject.giveandtake.UI.login.SplashScreenActivity.class);
    ...
    public void startSplashActivity() {
        Intent splashScreenActivity = new Intent(this, com.finalproject.giveandtake.UI.login.SplashScreenActivity.class);
